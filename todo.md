...
## Phase 55: Simplify Service Levels (5 Response Times → 3 Service Levels)

### Current System Analysis
- [ ] Document all places where response times are used (4h, 24h, 48h, 72h, 96h)
- [ ] Identify database tables affected (supplierRates, supplierResponseTimeExclusions, jobs, etc.)
- [ ] List all frontend components using response times
- [ ] Map existing response times to new service levels

### Database Schema Changes
- [x] Update supplierRates table: change responseTimeHours to serviceLevel enum
- [x] Update supplierResponseTimeExclusions table: change responseTimeHours to serviceLevel
- [x] Update jobs table: add serviceLevel field
- [x] Create migration script to convert existing data:
  * 4h → same_business_day
  * 24h → next_business_day
  * 48h, 72h, 96h → scheduled
- [x] Update shared/rates.ts constants file with new service levels

### Supplier Portal Updates
- [ ] Update Rate Management - Quick Setup tab (3 service levels instead of 5)
- [ ] Update Rate Management - By Location tab (3 columns instead of 5)
- [ ] Update Rate Management - By Service tab (3 columns instead of 5)
- [ ] Update Current Rates page (3 columns instead of 5)
- [ ] Update Service Availability page (response time exclusions → service level exclusions)
- [ ] Update Coverage Management - Response Times section (3 options instead of 5)
- [ ] Update Excel bulk import/export templates (3 columns instead of 5)
- [ ] Update rate validation warnings logic

### Customer Portal Updates
- [ ] Update RequestService form: replace response time dropdown with 3 service level options
- [ ] Update service level descriptions and pricing display
- [ ] Update RequestServicePricing page to show selected service level
- [ ] Update Jobs list page to display service level instead of response time
- [ ] Update JobDetail page to show service level

### Backend API Updates
- [ ] Update pricing calculation procedure (calculatePrice)
- [ ] Update rate CRUD procedures (upsertRate, bulkUpsertRates, etc.)
- [ ] Update job creation procedure
- [ ] Update rate completion stats calculation
- [ ] Update Excel import/export logic
- [ ] Update all queries filtering by responseTimeHours

### Testing & Migration
- [ ] Write vitest tests for new service level logic
- [ ] Test supplier rate management with 3 service levels
- [ ] Test customer request flow with 3 service levels
- [ ] Test pricing calculations
- [ ] Run data migration script on existing rates
- [ ] Verify all existing jobs display correctly
- [ ] Test Excel import/export with new format

### Documentation
- [ ] Update API documentation
- [ ] Update user guide for suppliers
- [ ] Update help text in UI components
