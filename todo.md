...
## PostgreSQL Migration - Dev to Production
- [ ] Install PostgreSQL in sandbox
- [ ] Create local PostgreSQL database
- [ ] Switch code to PostgreSQL driver (drizzle.config.ts, server/db.ts)
- [ ] Update DATABASE_URL to local PostgreSQL
- [ ] Run database migrations (pnpm db:push)
- [ ] Recreate test supplier account
- [ ] Test login and authentication
- [ ] Test rate management features
- [ ] Test coverage management features
- [ ] Verify all existing functionality works
- [ ] Commit and push to GitHub
- [ ] Deploy to Railway with PostgreSQL


## Decision: Stick with MySQL for Railway Deployment
- [x] Attempted PostgreSQL migration (too complex for current stage)
- [ ] Revert to MySQL configuration
- [ ] Restore MySQL schema file
- [ ] Restore mysql2 driver
